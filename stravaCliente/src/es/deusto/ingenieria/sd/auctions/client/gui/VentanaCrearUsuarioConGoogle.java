...
public class VentanaCrearUsuarioConGoogle extends JFrame {
	...
	public VentanaCrearUsuarioConGoogle(LoginController loginController, ErController erController) {
		...
		lblNewLabel.setIcon(new ImageIcon("iconos/GOOGLEMAX.png"));
		...
		btnRegistrarse.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					loginController.crearUsuario(TipoUsuarioDTO.GOOGLE, textEmail.getText(), textNickname.getText(), passwordField.getText(), 0, 0, 0, 0, 0);
