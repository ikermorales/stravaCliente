...
public class VentanaCrearUsuarioEmail extends JFrame {
	...
	public VentanaCrearUsuarioEmail(LoginController loginController, ErController erController) {
		...
		lblNewLabel.setIcon(new ImageIcon("iconos/EMAILMAX.png"));
		...
		btnRegistrarse.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					loginController.crearUsuario(TipoUsuarioDTO.EMAIL, textEmail.getText(), textNickname.getText(), passwordField.getText(), 0, 0, 0, 0, 0);
